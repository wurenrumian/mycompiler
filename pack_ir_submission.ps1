...
$tempDir = Join-Path $PWD ".pack_ir_submission_tmp"
...
Write-Host "Created $OutputZip for intermediate LLVM IR submission with $($filesToPack.Count) files."
